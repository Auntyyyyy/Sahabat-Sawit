        ...
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav">
                ...
                <a href="{{ route('admin.berita.index') }}"
                   class="admin-nav-link {{ request()->routeIs('admin.berita.*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4 5.5h13a2 2 0 012 2V17a2 2 0 01-2 2H6a2 2 0 01-2-2V5.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>
                        <path d="M8 9.5h7M8 13h7M8 16h4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
                    </svg>
                    Berita
                </a>
            </nav>
